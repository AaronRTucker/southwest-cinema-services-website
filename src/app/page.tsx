...
import aaronHeadshot from "../../public/images/aaron-headshot-clean.png";
import richardHeadshot from "../../public/images/richard-headshot-clean.jpg";
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <header className="bg-yellow-500 px-6 py-3 flex items-center justify-between sticky top-0 z-10">
        <div className="flex items-center gap-3">
          ...
          <span className={`${cinzel.className} text-sm sm:text-lg tracking-wide text-gray-900`}>Southwest Cinema Services, LLC</span>
        </div>
        <Link
          href="/login"
      ...
      <section className="bg-gray-50 px-6 py-20">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-16">
            {[
              { src: aaronHeadshot, name: "Aaron Tucker", pos: "object-[45%_20%]", bio: "Barco and Christie certified technician specializing in digital cinema projectors, laser systems, and SNMP-based monitoring." },
              { src: richardHeadshot, name: "Richard Tucker", pos: "object-[50%_20%]", bio: "Decades of experience servicing 35mm and digital cinema equipment, with deep expertise in optical alignment and sound systems." },
            ].map((person) => (
              <div key={person.name} className="flex flex-col items-center gap-4">
                <div className="w-36 h-36 rounded-full overflow-hidden border-4 border-white shadow-md flex-shrink-0">
                  <Image src={person.src} alt={person.name} width={144} height={144} className={`w-full h-full object-cover ${person.pos}`} placeholder="blur" />
                </div>
                <div>
